...
@NamedQueries({
      ...
      @NamedQuery(name = "HoaDonThanhToan.findByMaKhachHangNotPay", query = "SELECT h FROM HoaDonThanhToan h WHERE h.khachHang.maKhachHang = :maKhachHang AND h.tongTien = 0"),
      ...
      @NamedQuery(name = "HoaDonThanhToan.findByMaPhongDangSuDung", query = "SELECT h FROM HoaDonThanhToan h JOIN h.listCTP ct WHERE ct.phong.maPhong = :maPhong AND h.tongTien = 0"),
      ...
      @NamedQuery(name = "HoaDonThanhToan.findByPhoneCustomer", query = "SELECT h FROM HoaDonThanhToan h WHERE CAST(h.khachHang.soDienThoai AS string) LIKE :soDienThoai"),
      @NamedQuery(name = "HoaDonThanhToan.findByNameCustomer", query = "SELECT h FROM HoaDonThanhToan h WHERE h.khachHang.tenKhachHang LIKE :tenKhachHang"),
      @NamedQuery(name = "HoaDonThanhToan.findByDate", query = "SELECT h FROM HoaDonThanhToan h WHERE DAY(h.ngayLap) = DAY(:date) AND MONTH(h.ngayLap) = MONTH(:date) AND YEAR(h.ngayLap) = YEAR(:date)"),
      @NamedQuery(name = "HoaDonThanhToan.countBill", query = "SELECT COUNT(h) FROM HoaDonThanhToan h"),
      @NamedQuery(name = "HoaDonThanhToan.countBillByDate", query = "SELECT COUNT(h) FROM HoaDonThanhToan h WHERE DAY(h.ngayLap) = DAY(:date) AND MONTH(h.ngayLap) = MONTH(:date) AND YEAR(h.ngayLap) = YEAR(:date)"),
